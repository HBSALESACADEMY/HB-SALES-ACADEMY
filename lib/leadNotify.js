...
export async function meldeTerminAenderung(leadId, ereignis, beschreibung) {
  try {
    ...
    await apiPost("/api/lead-notify", { leadId, ereignis, beschreibung, activeOrgId: getActiveOrgId(profil) });
  } catch (e) {
