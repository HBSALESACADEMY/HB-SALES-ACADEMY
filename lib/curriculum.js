...
},
{
  ...
  examCase: { id:"kaltakquise-exam", prompt: "Du rufst bei einem interessanten Zielkunden an. Die Mitarbeiterin am Empfang fragt: \"Worum geht's denn, ich kann Sie auch einfach in ein Verzeichnis eintragen und der Chef ruft zurück, wenn Interesse besteht.\" Beschreibe dein konkretes Vorgehen: wie du die Empfangsperson nicht als Hindernis, sondern als Verbündete behandelst, und wie du trotzdem realistisch zum Entscheider durchkommst.", keyPoints:["Behandelt die Empfangsperson respektvoll, nicht als Hindernis, das umgangen werden muss","Nennt einen konkreten, glaubwürdigen Grund für den Rückruf statt vager Floskeln","Versucht eine niedrige Hürde zu setzen (kurzer Termin/Rückruf-Zeitfenster) statt sofortigen Abschluss zu erzwingen","Bleibt ehrlich darüber, was der Anruf bezweckt, statt zu verschleiern"] },
  modules: [
    {
