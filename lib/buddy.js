...
export const NICHTS_EINGETRAGEN = [
  "Du kannst im Gespräch nichts in der Academy eintragen oder ändern — keine Termine, keine Ergebnisse, keine Notizen.",
  "Behaupte nie, etwas eingetragen, gespeichert, notiert, übermittelt, weitergegeben oder vorgemerkt zu haben.",
  "Schreibt jemand ein Termin-Ergebnis oder einen neuen Termin, sag klar, dass es damit noch nicht in der Academy steht.",
  "Zum Eintragen: in einem Satz mit dem Namen des Kunden schreiben, z. B. \"Müller: Kunde geworden\" oder",
  "\"Schneider: Closing am Donnerstag 14 Uhr\" — dann schlägt die Academy den Eintrag zur Bestätigung vor. Oder /termine.",
];
