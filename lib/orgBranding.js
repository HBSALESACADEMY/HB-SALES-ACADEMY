...
// Kontrast einer Reihe von Vordergrundfarben (z.B. der Marken-Verlauf als
// Überschriften-Text) gegen EINE Hintergrundfarbe, wieder anhand des
// schlechtesten Verlaufspunkts. Für Überschriften genügt der WCAG-
// Schwellwert für große/fette Schrift (3:1) statt des strengeren 4.5:1 für
// Fließtext.
const MIN_HEADING_CONTRAST = 3;
// Für kleinere/fette UI-Texte (z.B. der aktive Sidebar-Eintrag, ~13.5px) ist
// das keine "große Schrift" mehr im WCAG-Sinne — hier gilt der strengere
// 4.5:1-Schwellwert für normalen Text.
const MIN_TEXT_CONTRAST = 4.5;
function worstContrastAgainst(hexColors, bgHex) {
...
export function applyOrgBranding(org) {
  ...
  // Überschriften-Verlauf gegen den (ggf. eigenen) Seitenhintergrund prüfen —
  // Standard-Hintergrund als Basis, falls die Organisation keinen eigenen setzt.
  setHeadingSafety(
    [org.secondary_color, org.primary_color, org.tertiary_color].filter(Boolean),
    org.background_color || "#0A0C13"
  );
  ...
  const sidebarTint = sidebarBase ? blend(sidebarBase, "#0A0C13", 0.72) : "#1F1730";
  ...
  // eigenen, meist dunkleren Verlauf.
