...
// "Welcher Kalendertag ist das?" — nach der Zeit des Geräts, als
// "JJJJ-MM-TT".
//
// Bewusst NICHT über toISOString(): das liefert UTC. Zwischen Mitternacht
// und dem UTC-Tageswechsel wäre das ein anderer Tag, und wer den einen und
// wer den anderen benutzt, kommt zu verschiedenen Antworten auf dieselbe
// Frage. Genau daran hat der Call Tracker nachts die Zahlen des Vortags
// überschrieben.
export function tagesSchluessel(d = new Date()) {
