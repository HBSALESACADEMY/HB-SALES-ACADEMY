...
// Eine Störung im Browser an den BETREIBER melden (Telegram).
//
// Nicht zu verwechseln mit meldeFehler() aus lib/errorBus.js: das zeigt der
// betroffenen Person einen Hinweis auf dem Bildschirm. Beides zusammen ist
// erst vollständig — der eine weiss, was gerade nicht ging, der andere,
...
export function meldeStoerung(wo, meldung) {
