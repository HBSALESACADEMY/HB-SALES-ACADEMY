...
export const FIELDS = [
  ...
  // keine zusätzlichen Anrufe. Alte Tage kennen diese Zähler nicht; dort
  // steht 0, ohne dass etwas anderes verrutscht.
  { key: "gatekeeper", label: "Gatekeeper", kind: "neutral" },
  { key: "entscheider", label: "Geschäftsführer", kind: "neutral" },
  // Am Vorzimmer vorbei: zählt nur bei Gatekeeper-Gesprächen. Daran misst
  // sich, wie gut jemand zur Entscheidung durchkommt.
  { key: "weitergeleitet", label: "Weitergeleitet", kind: "positive" },
