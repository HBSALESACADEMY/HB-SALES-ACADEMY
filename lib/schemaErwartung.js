...
export const ERWARTUNGEN = [
  ...
  { migration: 160, zweck: "Telegram-Kanal für Abschlüsse", tabelle: "organizations", spalte: "telegram_abschluss_chat_id" },
  { migration: 162, zweck: "Vorname und Nachname getrennt beim E-Mail-Kontakt", tabelle: "email_kontakte", spalte: "nachname" },
  { migration: 165, zweck: "Persönliche Telegram-Nachrichten und Tagesauswertung", tabelle: "telegram_verknuepfungen", spalte: "chat_id" },
  { migration: 165, zweck: "Zeitpunkt, an dem jemand Kunde geworden ist", tabelle: "leads", spalte: "kunde_am" },
  { migration: 167, zweck: "Onboarding: Plan, Zuweisungen und Haken", tabelle: "onboarding_zuweisungen", spalte: "gestartet_am" },
  { migration: 168, zweck: "Vertriebsbuddy: Wochenimpuls und Gespräch per Telegram", tabelle: "buddy_nachrichten", spalte: "richtung" },
  { migration: 169, zweck: "Wochenrückblick des Buddys und die Herausforderungen fürs Team", tabelle: "buddy_wochen", spalte: "herausforderungen" },
  { migration: 170, zweck: "Mini-Schulungen des Buddys mit Übung und Fazit", tabelle: "buddy_schulungen", spalte: "thema" },
  { migration: 171, zweck: "Telegram meldet Nachrichten sofort (Webhook)", tabelle: "telegram_updates", spalte: "chat_id" },
  { migration: 172, zweck: "Teamlage freitags an die Leitung", tabelle: "telegram_verknuepfungen", spalte: "teamlage" },
  { migration: 173, zweck: "Einwilligung in den Telegram-Bot nachweisbar", tabelle: "telegram_verknuepfungen", spalte: "einwilligung_am" },
  { migration: 175, zweck: "Morgen-Briefing und Rollenspiel im Vertriebsbuddy", tabelle: "telegram_verknuepfungen", spalte: "briefing" },
  { migration: 175, zweck: "Morgen-Briefing und Rollenspiel im Vertriebsbuddy", tabelle: "telegram_verknuepfungen", spalte: "modus" },
  { migration: 176, zweck: "Erklärung des Vertriebsbuddys einmal an alle", tabelle: "telegram_verknuepfungen", spalte: "erklaerung_am" },
  { migration: 177, zweck: "Eigenes Anwahl-Tagesziel im Call Tracker", tabelle: "profiles", spalte: "anwahl_tagesziel" },
  { migration: 178, zweck: "Neue Einwandgründe an die Leitung melden", tabelle: "telegram_verknuepfungen", spalte: "einwaende" },
  { migration: 179, zweck: "E-Mail-Marketing je Organisation abschaltbar", tabelle: "organizations", spalte: "email_marketing_aktiv" },
  { migration: 180, zweck: "E-Mail-Marketing nur für bestimmte Personen", tabelle: "organizations", spalte: "email_marketing_zugang" },
  { migration: 180, zweck: "E-Mail-Marketing nur für bestimmte Personen", tabelle: "organizations", spalte: "email_marketing_personen" },
  { migration: 181, zweck: "Telefonblöcke mit Dauer und Anwahlen aufbewahren", tabelle: "telefon_bloecke", spalte: "anwahlen" },
  { migration: 182, zweck: "Morgenbericht nur einmal täglich, auch bei zwei Weckern", tabelle: "cron_laeufe", spalte: "tag" },
];
...
export const WERT_ERWARTUNGEN = [
  {
    migration: 161,
    zweck: "Cold Call Bingo ausgebaut",
    tabelle: "nav_items",
    filter: { key: "bingo" },
    spalte: "visible",
    erwartet: false,
    hinweis: "Der Menüpunkt Cold Call Bingo steht noch auf sichtbar und führt ins Leere.",
  },
  {
    migration: 151,
