...
export function willkommensText({
  ...
  const ankommt = [
    ...
    "• Dein Morgen-Briefing um 8 Uhr: die Termine des Tages mit dem, was du vorher wissen solltest — und Knöpfe, mit denen du Ergebnisse von gestern mit einem Tippen einträgst",
...
export function buddyErklaerung({ istLeitung = false } = {}) {
  const zeilen = [
    ...
    "",
    "📈 Nächste Stufe",
    "„Closing Call ausgemacht“ genügt — ich zeige dir die passenden Kontakte, du tippst einen an und nennst Datum und Uhrzeit. Dann rückt er in der Academy weiter.",
    "",
    "✔️ Haken am Termin",
    "„Setting Call bestätigen“, „Check-in erledigt“ oder „Termin verschoben“ — ich zeige dir die passenden Termine, du tippst den richtigen an. Im Morgen-Briefing stehen die Knöpfe gleich darunter.",
    "",
    "➕ Neuen Termin anlegen",
    "Schreib „neuer Termin“ oder /termin — ich frage alles ab, was euer Termin-Formular verlangt, und lege ihn nach deiner Bestätigung an.",
    "",
    "☀️ Jeden Morgen um 8 (Mo–Fr)",
    ...
    "",
    "📊 Deine Zahlen",
    "/heute · /woche · /ziel · /termine (dein Tag)",
    "",
    "💬 Freitags",
