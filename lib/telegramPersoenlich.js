...
export function buddyErklaerung({ istLeitung = false } = {}) {
  const zeilen = [
    ...
    "",
    "✔️ Termine bestätigen",
    "Schreib „Setting Call bestätigen“ — ich zeige dir deine Termine, du tippst den richtigen an. Im Morgen-Briefing stehen die Knöpfe gleich darunter.",
    "",
