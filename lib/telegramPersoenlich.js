...
export function willkommensText({
  ...
  const fragen = [
    "/heute und /woche — deine Zahlen, /ziel — der Stand eurer Ziele, /termine — dein Tag",
    "/einwand — Hilfe bei einem Einwand, aus eurem eigenen Leitfaden",
    "/rollenspiel — ich spiele den Kunden, du übst",
  ];
  if (istLeitung) fragen.push("/gespraech Name — dein nächstes Einzelgespräch vorbereiten, /team — die Teamlage");
