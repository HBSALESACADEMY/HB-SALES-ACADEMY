...
export const TERMIN_ARTEN = [
  { key: "erstgespraech", label: "Setting-Termin", kurz: "ST", symbol: "", farbe: "#E0A458", fortschritt: 25,
  ...
  { key: "closing", label: "Closing Call", kurz: "CC", symbol: "💵", farbe: "#3FA7D6", fortschritt: 75,
