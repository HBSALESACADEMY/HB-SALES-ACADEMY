...
export async function notifyOrgManagers(admin, organizationId, { subject, html, fromName }) {
  try {
...
export async function notifyPlatformAdmins(admin, { subject, html, fromName }) {
  try {
