export const PERSONAS = [
  { id: "skeptiker", name: "Der Skeptiker", tagline: "Reagiert auf Autorität, Belege & soziale Bewährtheit", accent: "#3FBFA6",
  ...
  { id: "preisdruecker", name: "Der Preisdrücker", tagline: "Reagiert auf Framing, Ankereffekt & Verlustaversion", accent: "#F0B23E",
  ...
  { id: "techniker", name: "Der Techniker", tagline: "Reagiert auf Konsistenz, Fakten & Kongruenz", accent: "#E5716A",
  ...
  { id: "unentschlossen", name: "Der Unentschlossene", tagline: "Reagiert auf Neugier (Zeigarnik) & echte Dringlichkeit", accent: "#9E8CF0",
  ...
  { id: "choleriker", name: "Der Choleriker", tagline: "Reagiert auf Ruhe, Kongruenz & souveräne Deeskalation", accent: "#E5716A",
  ...
  { id: "vielredner", name: "Der Vielredner", tagline: "Testet aktives Zuhören & Fragetechnik (SPIN)", accent: "#F0B23E",
