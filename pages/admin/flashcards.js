...
export default function FlashcardsAdmin() {
  ...
  if (!isManager) {
    return (
      <Layout>
        ...
        <p className="text-textMuted text-sm">Diese Ansicht ist nur für Konten mit der Rolle "manager" oder "trainer" verfügbar.</p>
      </Layout>
    );
  }
  ...
  return (
    <Layout>
      <h1 className="text-2xl font-display font-bold brand-text-gradient mb-1">Flashcards verwalten</h1>
