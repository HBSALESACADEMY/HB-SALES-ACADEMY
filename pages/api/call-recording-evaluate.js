  ...
  try {
    ...
    const raw = await callAIWithAudio(
      "Du bist ein erfahrener Trainer für Verkaufspsychologie. Höre dir die angehängte Aufnahme eines Vertriebsanrufs " +
        ...
        "Zitiere außerdem bis zu 5 konkrete, WÖRTLICHE Formulierungen, die der/die Vertriebler:in tatsächlich im " +
        ...
        '"phrasenKorrektur": [{"original": "<wörtliches Zitat aus dem Gespräch>", "verbessert": "<korrigierte, bessere Formulierung>"}, max 5], ' +
    ...
    try {
      ...
      evaluation = { score: null, zusammenfassung: raw, phasen: [], staerken: [], verbesserung: [], einwaende: [], beispielsaetze: [], phrasenKorrektur: [], naechsteSchritte: "" };
    }
